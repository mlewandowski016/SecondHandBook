...
export default function NewOffer() {
  ...
  const [searchPhrase, setSearchPhrase] = useState(''); // Osobny stan dla searchPhrase
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h1 className="text-3xl font-bold text-center mb-8">Utwórz nową ofertę</h1>
          ...
          <div>
            ...
            {offerData.selectedBook && (
              <p className="mt-2 text-sm text-gray-600">
                Wybrana książka: {offerData.selectedBook.title} - {offerData.selectedBook.author} - ISBN {offerData.selectedBook.isbn}
              </p>
            )}
          </div>
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full p-2 border border-gray-300 rounded-md"
              placeholder="Opisz stan książki, dodatkowe informacje..."
